    ...
    <div className={`${location.pathname !== "/" && "pt-16"}`}>
      <div className="py-16 parent ">
        <motion.div initial="hidden" animate={viewDiv && "visible"} variants={headingAnimation}>
          <div className="mb-6">
            <h3 className="text-center text-accent">Segera Booking Slot Promo Sebelum Kehabisan!</h3>
            <h1 className="text-4xl font-semibold text-center">
              Harga <span className="text-primary">Tahun 2024</span>
            </h1>
            <BottomLine />
            <Countdown />
          </div>
        ...
        <motion.div ref={ref} initial="hidden" animate={viewDiv && "visible"} variants={sectionBodyAnimation}>
          ...
          <div className="flex flex-wrap items-center justify-center mt-6 mb-6">
            ...
            {activeBtn === "tokoonline" && (
              ...
              >
                Coming Soon Daftar Harga <span className="text-primary">Servis Laptop</span>
              </h3>
            )}
            {activeBtn === "companyprofile" && (
              ...
              >
                Coming Soon Daftar Harga <span className="text-primary">Servis Komputer</span>
              </h3>
            )}
          </div>
